...
#ifndef NIXL_OBJ_PLUGIN_S3_ACCEL_IBVERBS_DC_TOKEN_CLIENT_H
#define NIXL_OBJ_PLUGIN_S3_ACCEL_IBVERBS_DC_TOKEN_CLIENT_H
 ...
 */
class S3IbverbsDcTokenClient : public iS3RdmaTokenClient {
public:
    /**
     ...
     */
    S3IbverbsDcTokenClient(const std::vector<std::string> &nic_ips, uint64_t dc_key);
    ~S3IbverbsDcTokenClient() override;

    S3IbverbsDcTokenClient(const S3IbverbsDcTokenClient &) = delete;
    S3IbverbsDcTokenClient &
    operator=(const S3IbverbsDcTokenClient &) = delete;
...
#endif // NIXL_OBJ_PLUGIN_S3_ACCEL_IBVERBS_DC_TOKEN_CLIENT_H
